            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo url('link/lst'); ?>"">友情链接管理</a></li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="title" required="" value="<?php echo $links['title']; ?>" type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" placeholder="" name="link_url" value="<?php echo $links['link_url']; ?>" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <?php if($links['logo'] != ''): ?>
                                                    <img src="/shop/public/static/uploads/<?php echo $links['logo']; ?>" height="30">
                                                    <?php else: ?>暂无图片
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:10px;">
                                                        <label>
                                                            <input name="status" value="1" class="colored-blue" {if condition="$links['status'] eq 1" } checked="checked" {/if } type="radio">
                                                            <span class="text">显示</span>
                                                        </label>
                                                    </div>
                                                    <div class="radio" style="float:left;">
                                                        <label>
                                                            <input name="status" value="0" class="colored-blue" <?php if($links['status'] == 0): ?> checked="checked" <?php endif; ?> type="radio">
