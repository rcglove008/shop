                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio" style="float:left; padding-right:10px;">
                                                        <label>
                                                            <input name="show_nav" value="1" class="colored-blue" type="radio">
                                                            <span class="text">显示</span>
                                                        </label>
                                                    </div>
                                                    <div class="radio" style="float:left;">
                                                        <label>
                                                            <input name="show_nav" value="0" class="colored-blue" checked="checked" type="radio">
