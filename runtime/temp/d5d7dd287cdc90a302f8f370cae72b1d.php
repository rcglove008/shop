    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            ...
            <form action="" method="post">
                ...
                <tr><td colspan="6" align="right" style="padding-right: 17% "><input class="btn btn-primary  btn-sm shiny" type="submit" value="排序" /></td></tr>
                </tbody>
                </table>
                </form>
                </div>
