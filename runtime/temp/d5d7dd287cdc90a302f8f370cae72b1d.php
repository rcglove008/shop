    ...
    <li>
        ...
        <ul class="submenu">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                    <button type="button" tooltip="添加分类" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url ('add'); ?>'"> <i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                <thead class="">
                                                    <tr>
                                                        ...
                                                        <th class="text-center" width="5%">显示到导航栏</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo str_repeat('-', $cate['level'] * 8); ?><?php echo $cate['cate_name']; ?></td>
                                                        <td align="center">
                                                        ...
                                                        <td align="center">
                                                            <input class="text-center" type="text" style="width: 60px" name="sort[<?php echo $cate['id']; ?>]" value="<?php echo $cate['sort']; ?>">
                                                        </td>
                                                        <td align="center">
                                                    ...
                                                    <tr>
                                                        <td colspan="6" align="right" style="padding-right: 17% "><input class="btn btn-primary  btn-sm shiny" type="submit" value="排序" /></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </form>
