                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" name="pid">
                                                        ...
                                                        <option <?php if(($cate['cate_type']==1) OR ($cate['cate_type']==2) OR ($cate['cate_type']==3) OR ($cate['cate_type']==4)): ?> disabled="disabled" <?php endif; if($cate['cate_type'] != 5): ?> disabled="disabled" <?php endif; if($cates['id'] == $cate['id']): ?> disabled="disabled" <?php endif; if($cate['id'] == $cates['pid']): ?> selected="selected" <?php endif; ?> value="<?php echo $cates['id']; ?>">
